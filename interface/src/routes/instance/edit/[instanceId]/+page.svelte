...
<div class="p-5 select-none">
    ...
    <div class="flex flex-col gap-3 w-3/5 mt-5" transition:slide>
        ...
        <label class="label">
            ...
            <input type="text" class="input" placeholder="{instance.version_id}" bind:value={instance.name}>
        </label>
        ...
        <label class="label">
            ...
            <div class="flex items-center justify-center gap-3">
                <select bind:value={instance.version_id} class="input">
        ...
        <label class="label">
            ...
            <div class="flex gap-1 flex-wrap p-3 bg-primary-500/10 dark:bg-surface-700 rounded-xl select-none">
                {#each icons as icon}
                    <button on:click={() => instance.icon_path = icon} class="border-2 {instance.icon_path == icon ? 'border-white' : 'border-white/0'} duration-300 rounded-sm overflow-hidden p-[2px]">
        ...
        <button class="btn variant-filled-primary mt-5" on:click={() => {}}> Save Changes </button>
